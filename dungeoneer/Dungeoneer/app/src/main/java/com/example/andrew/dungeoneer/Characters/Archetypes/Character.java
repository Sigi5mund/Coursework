...
//    Stats and Status Getters:
    ...
    public Integer getAction1cost() {
        return this.action1cost;
    }

    public Integer getAction2cost() {
        return this.action2cost;
    }

    public Integer getAction3cost() {
        return this.action3cost;
    }

    public Integer getAction4cost() {
        return this.action4cost;
    }
