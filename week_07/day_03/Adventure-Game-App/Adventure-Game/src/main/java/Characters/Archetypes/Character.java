...
//    public double calculateParryDamage(Character target, Weapon weapon){
//        double damage;
//        if ( target.weapon.isCanParry() == true && weapon.isParryable()) == false);
//        damage =
//    }
